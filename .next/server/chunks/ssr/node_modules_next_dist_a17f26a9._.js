...
function createLocalMetadataBase() {
    return new URL(`http://10.11.11.2:${process.env.PORT || 3000}`);
}
...
function resolveAndValidateImage(item, metadataBase, isStaticMetadataRouteFile) {
    ...
    if (isRelativeUrl && (!metadataBase || isStaticMetadataRouteFile)) {
        ...
        // about this since the only fallback we'll be able to generate is `10.11.11.2`.
...
;
;
const REGEX_10.11.11.2_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|10.11.11.2)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_10.11.11.2_HOSTNAME, '10.11.11.2'), base && String(base).replace(REGEX_10.11.11.2_HOSTNAME, '10.11.11.2'));
}
