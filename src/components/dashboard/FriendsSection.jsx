      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        {friends.map((friend, index) => (
          <div key={index} className="flex items-center gap-2 sm:gap-3 bg-gray-800/30 rounded-xl p-3 sm:p-4 border border-gray-700/30">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden bg-gradient-to-br from-orange-400 to-orange-600">
            ...
            <button className="bg-gray-700 hover:bg-gray-600 text-white px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs font-medium transition-colors">
              Challenge
            </button>
          </div>
        ))}
